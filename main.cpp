...
int main() {
    ...
    std::cout<<"Plaintext before encryption : "<< input<<std::endl;
    ...
    std::cout<<"Ciphertext after encryption : "<< cipher<<std::endl;
    auto plain_text = decrypt(cipher, key, iv);
    std::cout<<"Plaintext after decryption : "<< plain_text<<std::endl;
